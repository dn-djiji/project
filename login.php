...
if (isset($_POST['register'])) {
  ...
  $select = mysqli_query($conn,"INSERT INTO `users`( `name`, `email`, `password`) VALUES ('$name','$email','$password')");
  if($select){
      $_SESSION['register'] =  "Un compte a été créé. Connecte-toi maintenant";
